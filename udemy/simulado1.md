...
**`2**`2`** - Uma empresa planeja migrar sistemas legados complexos para a AWS. A empresa usará vários sistemas operacionais, vários bancos de dados e várias linguagens de programação. Qual o benefício da Nuvem AWS que esse cenário representa?
